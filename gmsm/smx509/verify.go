...
type HostnameError = x509.HostnameError
...
type SystemRootsError = x509.SystemRootsError
...
func (c *Certificate) VerifyHostname(h string) error {
	...
	if ip := net.ParseIP(candidateIP); ip != nil {
		...
		return HostnameError{c.asX509(), candidateIP}
	}
	...
	return HostnameError{c.asX509(), h}
}
